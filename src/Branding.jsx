...
const Branding = () => {
  ...
  return (
    <div
      ref={brandingRef}
      className={`flex flex-col md:flex-row lg:flex-col lg:self-start self-center justify-center items-center gap-4 w-full lg:max-w-[300px] h-fit p-8 min-w-[min(600px, 100vw)] lg:min-w-min rounded-2xl animate-right-to-left lg:sticky transition-all duration-300 glass-card`}
      style={{ top: topValue }}>
